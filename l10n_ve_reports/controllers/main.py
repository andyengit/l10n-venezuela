...
from odoo.addons.l10n_ve_reports.models.account_report import AccountReportFileDownloadException
...
class AccountReportController(http.Controller):
    ...
    @http.route('/l10n_ve_reports', type='http', auth='user', methods=['POST'], csrf=False)
    ...
    @http.route('/l10n_ve_reports/download_attachments/<models("ir.attachment"):attachments>', type='http', auth='user')
