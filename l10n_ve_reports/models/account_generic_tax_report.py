...
class AccountTaxReportHandler(models.AbstractModel):
    ...
    def _get_custom_display_config(self):
        ...
        display_config['templates']['AccountReportFilters'] = 'l10n_ve_reports.GenericTaxReportFiltersCustomizable'
    ...
    def action_open_amls_with_archived_tags(self, options, params=None):
        return {
            ...
            'views': [(self.env.ref('l10n_ve_reports.view_archived_tag_move_tree').id, 'list')],
        }
...
class GenericTaxReportCustomHandler(models.AbstractModel):
    ...
    def _get_custom_display_config(self):
        ...
        parent_config['templates']['AccountReportLineName'] = 'l10n_ve_reports.TaxReportLineName'
        ...
        for column_group_key, column_group_options in report._split_options_per_column_group(options).items():
            ...
            if is_inconsistent:
                ...
                if error > 0.001:
                    ...
                    warnings['l10n_ve_reports.tax_report_warning_lines_consistency'] = {'alert_type': 'danger'}
