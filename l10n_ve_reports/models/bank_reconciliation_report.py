    ...
    def _customize_warnings(self, report, options, all_column_groups_expression_totals, warnings):
        ...
        if warnings is not None:
            ...
            if inconsistent_statement:
                warnings['l10n_ve_reports.inconsistent_statement_warning'] = {'alert_type': 'warning', 'args': inconsistent_statement}
            if has_bank_miscellaneous_move_lines:
                warnings['l10n_ve_reports.has_bank_miscellaneous_move_lines'] = {'alert_type': 'warning', 'args': journal.default_account_id.display_name}
