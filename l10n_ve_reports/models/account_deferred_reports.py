...
class DeferredReportCustomHandler(models.AbstractModel):
    ...
    def _get_custom_display_config(self):
        return {
            'templates': {
                'AccountReportFilters': 'l10n_ve_reports.DeferredFilters',
            },
        }
    ...
    def _customize_warnings(self, report, options, all_column_groups_expression_totals, warnings):
        if (
            ...
            if moves_lines_to_generate and already_generated:
                warnings['l10n_ve_reports.deferred_report_warning_partially_generated'] = {'alert_type': 'warning'}
            elif moves_lines_to_generate:
                warnings['l10n_ve_reports.deferred_report_warning_never_generated'] = {'alert_type': 'warning'}
            elif already_generated:
                warnings['l10n_ve_reports.deferred_report_info_fully_generated'] = {'alert_type': 'info'}
