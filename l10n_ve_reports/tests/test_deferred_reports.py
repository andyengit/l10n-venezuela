...
class TestDeferredReports(TestAccountReportsCommon, HttpCase):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.deferred_expense_report = cls.env.ref('l10n_ve_reports.deferred_expense_report')
        cls.deferred_revenue_report = cls.env.ref('l10n_ve_reports.deferred_revenue_report')
