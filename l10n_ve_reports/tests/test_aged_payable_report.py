...
class TestAgedPayableReport(TestAccountReportsCommon):
    ...
    def setUpClass(cls):
        ...
        cls.report = cls.env.ref('l10n_ve_reports.aged_payable_report')
        cls.parent_line_id = cls._get_basic_line_dict_id_from_report_line_ref("l10n_ve_reports.aged_payable_line")
