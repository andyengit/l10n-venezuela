...
export class BalanceSheetFilters extends AccountReportFilters {
    static template = "l10n_ve_reports.BalanceSheetFilters";
    static components = {
...
AccountReport.registerCustomComponent(BalanceSheetFilters);
