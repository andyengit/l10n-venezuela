...
export class GeneralLedgerFilters extends AccountReportFilters {
    static template = "l10n_ve_reports.GeneralLedgerFilters";
    static components = {
...
AccountReport.registerCustomComponent(GeneralLedgerFilters);
