...
class PaymentConcept(models.Model):
    ...
    def _handle_payment_concept_one(self):
        id_concept = (
            "l10n_ve_payment_extension.payment_concept_one_l10n_ve_payment_extension"
        )
        ...
        concept_lines = [
            ...
            },
            {
                ...
                "tariff_id": self.env.ref(
                    "l10n_ve_payment_extension.fees_retention_data_percentage_two_l10n_ve_payment_extension"
                ).id,
                "type_person_id": self.env.ref(
                    "l10n_ve_payment_extension.type_person_two_l10n_ve_payment_extension"
                ).id,
            },
            {
                "code": 5,
                ...
                "percentage_tax_base": 90,
                "tariff_id": self.env.ref(
                    "l10n_ve_payment_extension.fees_retention_data_percentage_five_l10n_ve_payment_extension"
                ).id,
                "type_person_id": self.env.ref(
                    "l10n_ve_payment_extension.type_person_four_l10n_ve_payment_extension"
                ).id,
            },
        ]
    ...
    def _handle_payment_concept_two(self):
        id_concept = (
            "l10n_ve_payment_extension.payment_concept_two_l10n_ve_payment_extension"
        )
        ...
        concept_lines = [
            {
                ...
                "percentage_tax_base": 100,
                "tariff_id": self.env.ref(
                    "l10n_ve_payment_extension.fees_retention_data_substrat_second_l10n_ve_payment_extension"
                ).id,
                "type_person_id": self.env.ref(
                    "l10n_ve_payment_extension.type_person_l10n_ve_payment_extension"
                ).id,
            },
            {
                ...
                "percentage_tax_base": 100,
                "tariff_id": self.env.ref(
                    "l10n_ve_payment_extension.fees_retention_data_percentage_four_l10n_ve_payment_extension"
                ).id,
                "type_person_id": self.env.ref(
                    "l10n_ve_payment_extension.type_person_three_l10n_ve_payment_extension"
                ).id,
    ...
    def _handle_payment_concept_three(self):
        ...
        concept_lines = [
            ...
            },
            {
                ...
                "percentage_tax_base": 100,
                "tariff_id": self.env.ref(
                    "l10n_ve_payment_extension.fees_retention_data_l10n_ve_percentage_three_payment_extension"
                ).id,
                "type_person_id": self.env.ref(
                    "l10n_ve_payment_extension.type_person_three_l10n_ve_payment_extension"
                ).id,
    ...
    def _handle_payment_concept_four(self):
        id_concept = (
            "l10n_ve_payment_extension.payment_concept_four_l10n_ve_payment_extension"
        )
    ...
    def _handle_payment_concept_six(self):
        id_concept = (
            "l10n_ve_payment_extension.payment_concept_six_l10n_ve_payment_extension"
        )
        ...
        concept_lines = [
            ...
            },
            {
                ...
                "type_person_id": self.env.ref(
                    "l10n_ve_payment_extension.type_person_seven_l10n_ve_payment_extension"
                ).id,
            },
        ]
    ...
    def _handle_payment_concept_seven(self):
        id_concept = (
            "l10n_ve_payment_extension.payment_concept_seven_l10n_ve_payment_extension"
        )
